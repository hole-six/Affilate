...
export const metadata: Metadata = {
  title: "Affiliate Hoàn Tiền — Mua sắm Shopee, TikTok Shop nhận hoàn tiền tự động",
  description:
  ...
  openGraph: {
    title: "Affiliate Hoàn Tiền — Mua sắm thông minh, nhận hoàn tiền tự động",
    description:
